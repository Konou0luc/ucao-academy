...
export default function VoirCoursFormateur() {
  ...
  if (notFound || !course) {
    return (
      <div className="flex-1 overflow-y-auto bg-gray-50 p-6">
        ...
        <Link href="/formateur/cours" className="inline-flex items-center gap-2 mt-4 text-[#03045e] font-medium">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Vue formateur — ressources et vidéo</p>
            </div>
          </div>
          <Link
            href={`/formateur/cours/${id}/edit`}
