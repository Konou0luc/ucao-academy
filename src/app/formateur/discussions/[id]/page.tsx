...
export default function FormateurDiscussionDetailPage() {
    ...
    discussionsApi
      ...
      .then((data) => {
        ...
        setDiscussion({
          ...
          replies: (Array.isArray(data.replies) ? data.replies : []).map((r: { _id: string; content: string; user_id?: { name: string; email?: string }; createdAt?: string; is_instructor?: boolean }) => ({
            id: String(r._id),
            content: r.content,
  ...
  if (error || !discussion) {
    return (
      <div className="flex-1 overflow-y-auto bg-gray-50 px-6 py-6">
        ...
        <Link href="/formateur/discussions" className="inline-flex items-center gap-2 mt-4 text-[#03045e] font-medium">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-semibold text-gray-900">{discussion.user.name}</h3>
              ...
              <form onSubmit={handleReply}>
                ...
                <div className="flex items-center justify-between mt-4">
                  <p className="text-sm text-gray-500">
                    Votre réponse sera visible par l'étudiant et les autres participants
                  </p>
                  <button
                    type="submit"
