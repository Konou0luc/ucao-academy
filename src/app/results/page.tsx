...
import { BarChart3, LayoutDashboard, Calendar, BookOpen } from "lucide-react";
    ...
    <MainLayout>
      <div className="flex-1 overflow-y-auto bg-gray-50 dark:bg-transparent">
        <div className="border-b border-gray-200 bg-white px-6 py-4 dark:border-gray-700 dark:bg-gray-800">
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Consultez vos notes et résultats académiques</p>
        </div>
        <div className="p-6">
          <div className="mx-auto max-w-lg rounded-xl border border-gray-100 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-800">
            <BarChart3 className="mx-auto mb-4 h-16 w-16 text-gray-400 dark:text-gray-500" />
            <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Fonctionnalité à venir</h2>
            <p className="mb-6 text-gray-600 dark:text-gray-400">
              Les notes et bulletins seront affichés ici dès que le module résultats sera disponible. En attendant, consultez le calendrier des examens et vos cours.
            </p>
